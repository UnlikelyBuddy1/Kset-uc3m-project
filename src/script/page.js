...
function createPlaylist(playlist, location){
  ...
  .then((data) => {
    for(let track of data.tracks){
      ...
      playbutton.src = "images/play.webp"
...
function displayProfileInformation(){
  ...
  profileCasette.src = "images/icon_notext.webp";
...
function displayArtistInformation(artist){
  ...
  artistCasette.src = "images/icon_notext.webp";
